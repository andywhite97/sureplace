          ...
          >Password<span
            ...
            >
              <i
                ...
                aria-hidden="true"
              ></i></button></span
          ><small id="password-error">{{ fieldError('password') }}</small></label
        >
        <a class="forgot" routerLink="/forgot-password">Forgot password?</a>
        <label class="remember"
          ><input type="checkbox" formControlName="remember" /> Remember me</label
        >
        @if (error()) {
...
export class LoginComponent {
  ...
  private handleError(error: unknown) {
    ...
    this.error.set(
      code === 'invalid_credentials' || code === 'token_not_found'
  ...
  private loginRedirectUrl() {
    ...
    const safeReturnUrl = value && value.startsWith('/') && !value.startsWith('//') ? value : '';
